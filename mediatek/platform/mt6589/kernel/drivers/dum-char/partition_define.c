...
struct excel_info PartInfo[PART_NUM]={
			...
			{"expdb",10485760,0x4400000, EMMC, 0,USER},
			{"android",734003200,0x4e00000, EMMC, 5,USER},
			{"cache",132120576,0x30a00000, EMMC, 6,USER},
			{"usrdata",2751463424,0x38800000, EMMC, 7,USER},
