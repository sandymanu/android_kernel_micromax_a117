...
inline static int Register_FM50AF_CharDrv(void)
{
    ...
    actuator_class = class_create(THIS_MODULE, "actuatordrv4");		//LINE <> <20130523> <add sensor:IMX179> lishengli
...
static struct platform_driver g_stFM50AF_Driver = {
    ...
    .driver		= {
        .name	= "lens_actuator4",		//LINE <> <20130523> <add sensor:IMX179> lishengli
        .owner	= THIS_MODULE,
    }
};
...
static int __init FM50AF_i2C_init(void)
{
    ...
    platform_device_register(&actuator_dev4);		//LINE <> <20130523> <add sensor:IMX179> lishengli
