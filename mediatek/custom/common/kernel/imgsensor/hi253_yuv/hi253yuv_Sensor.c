...
{ 
	...
	HI253WriteCmosSensor(0x61, 0x70);// 74 7E
...
HI253WriteCmosSensor(0x52, 0xb0); //b0
	...
	HI253WriteCmosSensor(0x62, 0x55); 
	HI253WriteCmosSensor(0x63, 0x55); 
	HI253WriteCmosSensor(0x64, 0x55); 
	HI253WriteCmosSensor(0x65, 0x55); 
	HI253WriteCmosSensor(0x66, 0x55); 
	HI253WriteCmosSensor(0x67, 0x55); 
	HI253WriteCmosSensor(0x68, 0x56); 
	HI253WriteCmosSensor(0x69, 0x95); 
	HI253WriteCmosSensor(0x6a, 0x56);
	HI253WriteCmosSensor(0x6b, 0x95);
	HI253WriteCmosSensor(0x6c, 0x55);
	HI253WriteCmosSensor(0x6d, 0x55);
	HI253WriteCmosSensor(0x6e, 0x55);
	...
	HI253WriteCmosSensor(0xb2, 0x90); //d0
  ...
  HI253WriteCmosSensor(0x40, 0xf7); // YRANGE
	...
	HI253WriteCmosSensor(0x41, 0x72); //44
  ...
  HI253WriteCmosSensor(0x83, 0x4a); // RMAX
  HI253WriteCmosSensor(0x84, 0x20); // RMIN
  HI253WriteCmosSensor(0x85, 0x53); // BMAX
  HI253WriteCmosSensor(0x86, 0x32); // BMIN
...
BOOL HI253SetWb(UINT16 Para)
{
  ...
  switch (Para)
  {
    ...
    case AWB_MODE_AUTO:
		...
		HI253WriteCmosSensor(0x86, 0x32);
